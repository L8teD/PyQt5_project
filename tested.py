...
"}")
        ...
        self.pushButton_switch.setGeometry(QtCore.QRect(286, 0, 131, 27))
        ...
        self.pushButton_send = QtWidgets.QPushButton(self.splitter)
    ...
    def retranslateUi(self, MainWindow_test):
        ...
        self.pushButton_switch.setText(_translate("MainWindow_test", "Поменять языки"))
        self.pushButton_new.setText(_translate("MainWindow_test", "Новое слово"))
        self.pushButton_send.setText(_translate("MainWindow_test", "Отправить"))
